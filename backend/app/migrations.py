...
TABLE_COLUMNS_SPEC = {
    ...
    "document_chunks": [
        ...
        ("summary", "TEXT", "TEXT", "DEFAULT NULL"),
        ("heading", "VARCHAR(255)", "VARCHAR(255)", "DEFAULT NULL"),
        ("key_entities", "JSON", "JSON", "DEFAULT NULL"),
        ("token_count", "INTEGER", "INTEGER", "DEFAULT 0"),
        ("embedding_id", "VARCHAR(100)", "VARCHAR(100)", "DEFAULT NULL"),
        ("embedding_vector", "JSON", "JSON", "DEFAULT NULL"),
        ("created_at", "TIMESTAMP", "DATETIME", "DEFAULT CURRENT_TIMESTAMP"),
    ],
    "questions": [
        ("id", "SERIAL PRIMARY KEY", "INTEGER PRIMARY KEY", None),
        ...
        ("subtopic_name", "VARCHAR(200)", "VARCHAR(200)", "DEFAULT NULL"),
        ("question_text_mr", "TEXT", "TEXT", "DEFAULT ''"),
        ("question_text_en", "TEXT", "TEXT", "DEFAULT NULL"),
        ("option_a_mr", "TEXT", "TEXT", "DEFAULT ''"),
        ("option_b_mr", "TEXT", "TEXT", "DEFAULT ''"),
        ("option_c_mr", "TEXT", "TEXT", "DEFAULT ''"),
        ("option_d_mr", "TEXT", "TEXT", "DEFAULT ''"),
        ("option_a_en", "TEXT", "TEXT", "DEFAULT NULL"),
        ("option_b_en", "TEXT", "TEXT", "DEFAULT NULL"),
        ("option_c_en", "TEXT", "TEXT", "DEFAULT NULL"),
        ("option_d_en", "TEXT", "TEXT", "DEFAULT NULL"),
        ("correct_option", "VARCHAR(10)", "VARCHAR(10)", "DEFAULT 'A'"),
        ("explanation_mr", "TEXT", "TEXT", "DEFAULT ''"),
        ("explanation_en", "TEXT", "TEXT", "DEFAULT NULL"),
        ("reference_source", "VARCHAR(255)", "VARCHAR(255)", "DEFAULT NULL"),
        ("difficulty", "VARCHAR(50)", "VARCHAR(50)", "DEFAULT 'medium'"),
        ("question_type", "VARCHAR(50)", "VARCHAR(50)", "DEFAULT 'mcq'"),
        ("mpsc_year", "INTEGER", "INTEGER", "DEFAULT NULL"),
        ("mpsc_exam_type", "VARCHAR(100)", "VARCHAR(100)", "DEFAULT NULL"),
        ("created_at", "TIMESTAMP", "DATETIME", "DEFAULT CURRENT_TIMESTAMP"),
    ],
    "tests": [
        ("id", "SERIAL PRIMARY KEY", "INTEGER PRIMARY KEY", None),
    ...
    "revision_items": [
        ...
        ("last_reviewed", "TIMESTAMP", "DATETIME", "DEFAULT NULL"),
        ("next_review_due", "TIMESTAMP", "DATETIME", "DEFAULT CURRENT_TIMESTAMP"),
        ("created_at", "TIMESTAMP", "DATETIME", "DEFAULT CURRENT_TIMESTAMP"),
    ],
}
