...
TABLE_COLUMNS_SPEC: Dict[str, List[Tuple[str, str, str, Optional[str], Optional[str]]]] = {
    ...
    "books": [
        ...
        ("is_generated", "BOOLEAN", "BOOLEAN", "DEFAULT FALSE", "DEFAULT 0"),
        ("source_book_id", "INTEGER", "INTEGER", "DEFAULT NULL", "DEFAULT NULL"),
        ("chat_session_id", "INTEGER", "INTEGER", "DEFAULT NULL", "DEFAULT NULL"),
        ("created_at", "TIMESTAMP", "DATETIME", "DEFAULT CURRENT_TIMESTAMP", "DEFAULT CURRENT_TIMESTAMP"),
    ...
    "chat_sessions": [
        ...
        ("attached_book_ids", "JSON", "JSON", "DEFAULT '[]'::json", "DEFAULT '[]'"),
        ("created_at", "TIMESTAMP", "DATETIME", "DEFAULT CURRENT_TIMESTAMP", "DEFAULT CURRENT_TIMESTAMP"),
        ("updated_at", "TIMESTAMP", "DATETIME", "DEFAULT CURRENT_TIMESTAMP", "DEFAULT CURRENT_TIMESTAMP"),
    ],
    "chat_messages": [
